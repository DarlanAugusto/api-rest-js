...
router.get('/:alunoId', _AlunoController2.default.show);
router.post('/', _loginRequired2.default, _AlunoController2.default.store);
router.put('/:alunoId', _loginRequired2.default, _AlunoController2.default.update);
router.delete('/:alunoId', _loginRequired2.default, _AlunoController2.default.delete);
